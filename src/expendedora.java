                 ...
                 switch (opcio){
                    ...
                    case 2:
                        if(almenys) {
                            ...
                            System.out.println("ʜᴀs ᴅᴇ ᴄᴏɴꜰɪɢᴜʀᴀʀ ᴇʟs ᴘʀᴏᴅᴜᴄᴛᴇs ᴀʟᴍᴇɴʏs ᴜɴ ᴘɪᴄ ❗");
                            break;
                        }
                    case 3:
                        if(almenys) {
